...
## List of Parts
**Screws:**\
We wanted to use screwdrivers and little tools as much as possible so we adopted the DIN 7985 standard for all the screws on this printer which are pozi pan head machine screws.
